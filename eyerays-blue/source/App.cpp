...
void App::onInit() {
    ...
    artTimeIncrement = M_PI/3000.0f; 
    int depth(7); 

    uint32 seed(13411422); //mountain like cool! 
    //uint32 seed(13411); //other cool seeds 
    //uint32 seed(24323); 
...
void App::makeGUI() {
    ...
    rtPane->addNumberBox("Build Time", &m_rayTracerStats.buildTriTreeTimeMilliseconds, "ms"); 
    rtPane->addNumberBox("Trace Time", &m_rayTracerStats.rayTraceTimeMilliseconds, "ms");
